...
\column{122}{@{}>{\hspre}l<{\hspost}@{}}%
\column{124}{@{}>{\hspre}l<{\hspost}@{}}%
\column{142}{@{}>{\hspre}l<{\hspost}@{}}%
\column{187}{@{}>{\hspre}c<{\hspost}@{}}%
\column{187E}{@{}l@{}}%
\column{196}{@{}>{\hspre}c<{\hspost}@{}}%
\column{196E}{@{}l@{}}%
\column{202}{@{}>{\hspre}c<{\hspost}@{}}%
\column{202E}{@{}l@{}}%
\column{209}{@{}>{\hspre}l<{\hspost}@{}}%
\column{217}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin 
invTLTree inverte o ponto nas suas coordenadas e mantem os ramos das arvores \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{invTLTree}\mathrel{=}\Varid{cataTLTree}\;(\Varid{inTLTree}\comp ((\lambda ((\Varid{x},\Varid{y}),\Varid{z})\to ((\mathbin{-}\Varid{x},\mathbin{-}\Varid{y}),\mathbin{-}\Varid{z}))+\Varid{id})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin 
invTLTree' inverte apenas os ramos da arvore a semelhança das outras funções de inversão para outros tipos de árvore \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{invTLTree'}\mathrel{=}\Varid{cataTLTree}\;(\Varid{inTLTree}\comp (\Varid{id}+(\lambda (\Varid{a},(\Varid{b},\Varid{c}))\to (\Varid{c},(\Varid{b},\Varid{a}))))){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{geraSierpinPair}\;(((\Varid{x},\Varid{y}),\Varid{z}),\Varid{a}){}\<[32]%
\>[32]{}\mid \Varid{a}\equiv \mathrm{0}{}\<[41]%
\>[41]{}\mathrel{=}i_1\;((\Varid{x},\Varid{y}),\Varid{z}){}\<[E]%
\\
\>[41]{}\hsindent{81}{}\<[122]%
\>[122]{}\mid \Varid{otherwise}\mathrel{=}i_2\;({}\<[142]%
\>[142]{}(((\Varid{x},\Varid{y}),\Varid{h}),(\Varid{a}\mathbin{-}\mathrm{1})),{}\<[E]%
\\
\>[142]{}\hsindent{54}{}\<[196]%
\>[196]{}({}\<[196E]%
\\
\>[196]{}\hsindent{21}{}\<[217]%
\>[217]{}(((\Varid{x}\mathbin{+}\Varid{h},\Varid{y}),\Varid{h}),(\Varid{a}\mathbin{-}\mathrm{1})),{}\<[E]%
\\
\>[196]{}\hsindent{13}{}\<[209]%
\>[209]{}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{h}),\Varid{h}),(\Varid{a}\mathbin{-}\mathrm{1})){}\<[E]%
\\
\>[196]{}\hsindent{6}{}\<[202]%
\>[202]{}){}\<[202E]%
\\
...
\\
\>[122]{}\hsindent{2}{}\<[124]%
\>[124]{}\mathbf{where}\;\Varid{h}\mathrel{=}(\Varid{quot}\;\Varid{z}\;\mathrm{2}){}\<[E]%
\\[\blanklineskip]%
