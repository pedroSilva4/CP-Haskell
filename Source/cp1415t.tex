...
\\
\>[B]{}\mbox{\onelinecomment qsplit = undefined}{}\<[E]%
\\
\>[B]{}\Varid{qsplit}\mathrel{=}\mcond{(\lambda (\Varid{a},\Varid{b})\to \Varid{a}\leq \Varid{b}\mathrel{\wedge}\Varid{a}\geq \mathrm{0}\mathrel{\wedge}\Varid{b}\mathbin{>}\mathrm{0})}{(i_2\comp \Varid{func})}{(i_1\comp (\mathbin{!}))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{func}\mathbin{::}\Conid{Integral}\;\Varid{a}\Rightarrow (\Varid{a},\Varid{a})\to (\Varid{a},((\Varid{a},\Varid{a}),(\Varid{a},\Varid{a}))){}\<[E]%
\\
\>[B]{}\Varid{func}\;(\Varid{n},\Varid{m})\mathrel{=}(\Varid{m}\mathbin{-}\Varid{n}\div \mathrm{2}\mathbin{+}\Varid{n},((\Varid{n},\Varid{m}\mathbin{-}\Varid{n}\div \mathrm{2}\mathbin{+}\Varid{n}\mathbin{-}\mathrm{1}),(\Varid{m}\mathbin{-}\Varid{n}\div \mathrm{2}\mathbin{+}\Varid{n}\mathbin{+}\mathrm{1},\Varid{m}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{mgen}\;([\mskip1.5mu \mskip1.5mu],\Varid{a}\mathbin{:}\Varid{t})\mathrel{=}i_2\;(\Varid{a},([\mskip1.5mu \mskip1.5mu],\Varid{t})){}\<[E]%
\\
\>[B]{}\Varid{mgen}\;(\Varid{a}\mathbin{:}\Varid{ts},\Varid{l})\mathrel{=}i_2\;(\Varid{a},(\Varid{ts},\Varid{l})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{invTLTree'}\mathrel{=}\Varid{cataTLTree}\;(\Varid{inTLTree}\comp (\Varid{id}+(\lambda (\Varid{a},(\Varid{b},\Varid{c}))\to (\Varid{a},(\Varid{b},\Varid{c}))){}\<[70]%
\>[70]{})){}\<[E]%
\\[\blanklineskip]%
